...
/**
 * show providers in panel page @todo should be in a view?
 * 
 * @param providers
 */
function setProviders(providers) {
	...
	$.each(providers, function(i, data) {
		...
		var compiled_template = _.template($("#tab_list_template").html());
		data = $.extend(data, { 'active' : (firstActive ? true : false) });
		var computed = compiled_template(data);
		$("#tabs_list").append(computed);

		compiled_template = _.template($("#tab_view_template").html());
		computed = compiled_template(data);
